...
export const resumeData = {
  ...
  skills: {
    ...
    learning: [
      "System Design Principles", "Advanced Cloud Architectures", "Microservices"
    ],
    academic: [
  ...
  education: [
    {
      ...
      year: "Expected Sept 2027",
    },
    {
      degree: "Intermediate Certificate (MPC)",
      institution: "Narayana Junior College, Madhapur, Hyderabad",
      year: "Completed April 2023",
    },
  ],

  experience: [], // Projects and competitive programming serve as primary proof of skill. Open to immediate internships and full-time post-grad roles.
  ...
  projects: [
    ...
    },
    {
      ...
      description:
        "Solved 100+ algorithmic problems spanning Arrays, Strings, Dynamic Programming, Binary Search, Graph Traversals, " +
        "and String Matching (e.g., Rotated Sorted Array Search, House Robber, Regular Expression Matching) on LeetCode and CodeChef in C++.",
...
────────────────────────────────────────────────────────────
SUMANTH REDDY KASIREDDY — PROFESSIONAL PROFILE
────────────────────────────────────────────────────────────
Name: Sumanth Reddy Kasireddy
...
Education:
- Bachelor of Technology in Computer Science & Engineering (Expected Sept 2027)
  SR International Institute of Technology, Hyderabad
- Intermediate Certificate (MPC - Mathematics, Physics, Chemistry) (Completed April 2023)
...
────────────────────────────────────────────────────────────
• Degree: B.Tech in CS & Engineering (Graduation expected September 2027).
• Internships: Open to software engineering / full-stack / frontend internship opportunities immediately.
• Full-Time: Open to full-time engineering roles post-graduation in September 2027.
